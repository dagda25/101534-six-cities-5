...
describe(`Reducer should change offers list and current city offers correctly`, () => {
  it(`Reducer should change offers list and current city offers to a given value`, () => {
    expect(reducerData({
      offersList: [],
      currentCityOffers: [],
      currentCity: `Paris`,
...
describe(`Reducer should change favorites property correctly`, () => {
  it(`Reducer should change favorites property to a given value`, () => {
    expect(reducerData({
      offersList: [],
      currentCityOffers: [],
      currentCity: `Paris`,
...
describe(`Reducer should change nearByOffers property correctly`, () => {
  it(`Reducer should change nearByOffers property to a given value`, () => {
    expect(reducerData({
      offersList: [],
      currentCityOffers: [],
      currentCity: `Paris`,
